...
import (
	...
	"github.com/eveld/ddr-api/protos/dda"
...
// GetAllocations fuck
func (s *Server) GetAllocations(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*dda.Allocations, error) {
	return nil, nil
}

// StopAllocation fuck
func (s *Server) StopAllocation(ctx context.Context, in *dda.Allocation, opts ...grpc.CallOption) (*dda.Allocation, error) {
	return nil, nil
}
